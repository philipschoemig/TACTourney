...
class Configurator(object):
    ...
    options = [
        ...
        ConfigOption('application', 'testing', 'TESTING', ConfigOption.Types.boolean),
        ConfigOption('application', 'debugging', 'DEBUG', ConfigOption.Types.boolean),
        ...
        ConfigOption('mail', 'use_ssl', 'MAIL_USE_SSL', ConfigOption.Types.boolean),
        ConfigOption('mail', 'use_tls', 'MAIL_USE_TLS', ConfigOption.Types.boolean),
        ...
        ConfigOption('recaptcha', 'use_ssl', 'RECAPTCHA_USE_SSL', ConfigOption.Types.boolean),
        ]
    ...
    def parse(self):
        ...
        '''
        self.config_parser.readfp(open(self.config['DEFAULT_CONFIG_PATH'], 'r'))
